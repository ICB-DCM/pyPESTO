...
class ProfilerTest(unittest.TestCase):
    ...
    def test_selected_profiling(self):
        ...
        self.assertIsInstance(
            result.profile_result.list[0][1], profile.ProfilerResult
        )
        ...
        self.assertIsInstance(
            result.profile_result.list[0][0], profile.ProfilerResult
        )
        ...
        # check result
        self.assertIsInstance(
            result.profile_result.list[1][0], profile.ProfilerResult
        )
