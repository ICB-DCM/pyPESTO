...
AMICI_SLLH = "sllh"  # return field in amici simulation result
AMICI_CHI2 = "chi2"  # return field in amici simulation result
AMICI_SCHI2 = "schi2"  # return field in amici simulation result
AMICI_FIM = "fim"  # return field in amici simulation result
AMICI_RES = "res"  # return field in amici simulation result
AMICI_SRES = "sres"  # return field in amici simulation result
