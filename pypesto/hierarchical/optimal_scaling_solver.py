"""
Optimal scaling solver.

For more background:

.. [SchmiesterWei2021] "Efficient gradient-based parameter estimation for
   dynamic models using qualitative data", Leonard Schmiester, Daniel Weindl,
   Jan Hasenauer,
